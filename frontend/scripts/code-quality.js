...
function runEslint() {
  ...
  if (eslintOutput.includes("error")) {
    console.log(`${colors.red}ESLint found errors. Run 'npm run lint:fix' to fix them.${colors.reset}`)
  } else {
...
function runPrettier() {
  ...
  if (prettierOutput.includes("Code style issues")) {
    console.log(`${colors.yellow}Prettier found formatting issues. Running formatter...${colors.reset}`)
