...
export const sidebarConfig: Record<Role, (base: string) => NavItem[]> = {
  artist: (base: string) => [
    ...
    { name: 'Portfolio', href: `${base}/portfolio`, icon: Image },
    { name: 'Storefront', href: `${base}/storefront`, icon: ShoppingBag },
  ...
  brand_manager: (base: string) => [
    ...
    { name: 'Storefront', href: `${base}/storefront`, icon: ShoppingBag },
    { name: 'Content', href: `${base}/posts`, icon: Newspaper },
  ...
  admin: (base: string) => [
    ...
    { name: 'Storefront', href: `${base}/storefront`, icon: ShoppingBag },
    { name: 'Content', href: `${base}/content`, icon: Newspaper },
