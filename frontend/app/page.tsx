      ...
      <section className="relative w-full h-[80vh] min-h-[420px] overflow-hidden">
        ...
        <div className="absolute top-[15%] left-1/2 -translate-x-1/2 text-center text-white max-w-3xl px-4 z-20 mb-10 mt-8">
          ...
          <p className="mt-4 text-sm text-gray-300">
            MOD Fan Official is a structured fan licensing platform that connects artists and brands
            through brand-approved submissions, official reviews, and licensed merchandise drops.
              ...
              <div key={i} className="flex items-center">
                ...
                {i < 2 && (
                  <div className="hidden md:block w-8 flex-shrink-0">
                    <img src={arrowImg.src} alt="arrow" className="w-8 h-7 object-contain" />
                  </div>
                )}
              </div>
            ))}
      ...
      >
        <div className="max-w-6xl mx-auto">
          ...
          <p className="mt-3 text-sm text-gray-600">
            MOD runs official fan art licensing campaigns with brands across entertainment, gaming,
          ...
          <div className="mt-4 flex flex-col items-center gap-3">
            ...
            <p className="mt-3 text-sm text-gray-600">
              These aren’t speculative uploads. <br /> They’re structured opportunities backed by
              real IP holders.
            </p>
          </div>
        ...
        >
          ...
          <div className="relative z-10 text-center text-white">
            ...
            <p className="mt-4 text-gray-300 text-sm">
              Whether you're a brand looking to activate your fandom safely or an artist looking to
              monetize fan art legally, MOD Fan Official gives you a clear place to start.
            </p>
