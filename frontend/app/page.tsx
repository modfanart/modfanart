...
function SafeImage({ src, alt = "", fill = false, className = "", ...rest }) {
  // Treat missing/empty src as a placeholder
  const isEmpty = !src || String(src).trim() === "";
  if (isEmpty) {
    // Placeholder preserves the aspect/space (works with fill or fixed sizing)
    return (
      <div
        aria-label={alt || "image placeholder"}
        className={`relative ${fill ? "w-full h-full" : "w-full h-full"} ${className} bg-gray-200`}
      >
        {/* Subtle shimmer/pulse to indicate placeholder in production */}
  ...
  // Real image
  return (
    <Image src={src} alt={alt} fill={fill} className={className} {...rest} />
  );
}
...
export default function HomePage() {
  ...
  <div className="absolute top-[15%] left-1/2 -translate-x-1/2 text-center text-white max-w-3xl px-4 z-20 mb-10">
    ...
    <p className="mt-4 text-sm text-gray-300">
      MOD Fan Official is a structured fan licensing platform that connects artists and brands through brand-approved submissions, official reviews, and licensed merchandise drops.
      Every design enters through a structured review and licensing process.
    </p>
    ...
    👁 View Active Contests
        ...
        <section className="bg-[#E9E3F5] py-24 px-6 text-center animate-fade-in-up ">
          <div className="max-w-5xl mx-auto">
            ...
            <p className="mt-3 text-sm text-gray-600 max-w-xl mx-auto">
              Fan art has always been part of culture.  What’s been missing is a clear, legal way for it to become official. MOD creates that path.
            </p>
            ...
            <div className="mt-8">
              ...
              <p className="mt-3 text-sm text-gray-600 max-w-xl mx-auto">
                No guessing. No copyright gray areas. <br /> Just a process that respects both creativity and IP.
              </p>
            </div>
          </div>
        </section>
      ...
      <section className="bg-black text-white py-24 px-6">
        <div className="max-w-6xl mx-auto space-y-16">
          ...
          <div className="grid md:grid-cols-2 gap-10 items-center">
            <div>
              ...
              <p className="mt-4 text-gray-400 text-sm">
                Fans already create artwork inspired by your IP. That doesn’t stop whether you engage or not.
                MOD gives brands a way to participate without losing control.
              </p>
              <p className="mt-2 text-gray-400 text-sm">
                You set the rules. <br />You review submissions. <br />You decide what becomes official.
                The result is safer fan engagement, licensed fan merchandise, and campaigns that feel intentional instead of risky.
              </p>
              <p className="mt-2 text-gray-400 text-sm">
            ...
            <div className="relative h-[320px] rounded-2xl overflow-hidden">
              <SafeImage src="https://res.cloudinary.com/dbsdj2f2l/image/upload/f_auto,q_auto/homepage-4_zqgxz6" alt="Brand art" fill className="object-cover" />
            </div>
          </div>
          ...
          <div className="grid md:grid-cols-2 gap-10 items-center">
            <div className="relative h-[320px] rounded-2xl overflow-hidden">
              <SafeImage src="https://res.cloudinary.com/dbsdj2f2l/image/upload/f_auto,q_auto/homepage-5_lzkqew" alt="Artist art" fill className="object-cover" />
            </div>

            <div>
              <h3 className="text-2xl font-semibold">Built for Artists</h3>
              <p className="mt-4 text-gray-400 text-sm">
                Most fan art lives in a legal gray zone.<br /> That makes it hard to share, harder to monetize, and nearly impossible to build a future around.
                MOD gives artists a real way in.
                </p>
              <p className="mt-2 text-gray-400 text-sm">
                You submit work tied to official fan art contests.<br/> Your designs are reviewed instead of ignored.<br/> If approved, your work becomes licensed merchandise and earns royalties.
                </p>
              <p className="mt-2 text-gray-400 text-sm">
                When your design is selected, it becomes officially licensed merchandise backed by the brand, with real recognition and royalties attached.
              </p>
            </div>
          </div>
      ...
      <section className="bg-white py-24 px-6 text-center" aria-label="Featured campaigns">
        <div className="max-w-6xl mx-auto">
          ...
          <p className="mt-3 text-sm text-gray-600">
            MOD runs official fan art licensing campaigns with brands across entertainment, gaming, media, and fandom culture.
          </p>
          <p className="mt-2 text-sm text-gray-600">
            Each campaign includes:<br/>
          ...
          <div className="grid md:grid-cols-3 gap-6 mt-12">
            ...
            "https://res.cloudinary.com/dbsdj2f2l/image/upload/f_auto,q_auto/homepage-8_pdl9fw"].map((i) => (
              <div key={i} className="bg-gray-100 rounded-xl overflow-hidden transform hover:scale-105 transition-transform duration-300">
        ...
        <div className="max-w-5xl mx-auto">
          ...
          <div className="flex flex-col md:flex-row gap-10 items-start">
            ...
            <div className="flex-1 space-y-7">
              {[
                { icon: "💡", color: "bg-purple-100", text: "Fan creativity has always driven fandom forward. Licensing systems just weren't built to include it." },
                { icon: "🎨", color: "bg-pink-100",   text: "We believe fan art deserves structure, not chaos. We believe brands should be able to collaborate without risk." },
                { icon: "🔗", color: "bg-indigo-100", text: "And we believe official pathways create better outcomes than gray areas ever could." },
                { icon: "❓", color: "bg-violet-100", text: "Artists were left guessing what was allowed. Brands were left choosing between enforcement or silence. MOD exists to change that." },
              ].map(({ icon, color, text }, i) => (
                <div key={i} className="flex items-start gap-4">
                  <div className={`${color} rounded-full w-9 h-9 flex items-center justify-center shrink-0 text-base`}>
                    {icon}
                  </div>
      ...
      <section className="bg-black py-24 px-6">
        <div className="max-w-5xl mx-auto text-center text-white relative rounded-2xl overflow-hidden">
          ...
          <div className="relative z-10 p-12">
            ...
            <p className="mt-4 text-gray-300 text-sm">Whether you’re a brand looking to activate your fandom safely or an artist looking to monetize fan art legally, MOD Fan Official gives you a clear place to start.
            </p>

            <div className="mt-6 flex justify-center gap-3 flex-wrap">
              {["Explore campaigns", "Submit artwork", "Launch brand activation"].map((t, i) => (
                <div key={i} className="bg-white/10 px-4 py-2 rounded-full text-xs hover:bg-white/20 transition-colors">
                  ✔ {t}
                </div>
              ))}
            </div>
            ...
            <div className="mt-6 flex justify-center gap-4">
              <Button className="bg-purple-600 rounded-full px-6">
                Sign Up Now
              </Button>
