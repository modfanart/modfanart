...
import { useGetMyArtworksQuery, useDeleteArtworkMutation } from '@/app/api/artworkApi'; // ← import your RTK Query hook
import { ArtworkListItem } from '@/app/api/artworkApi'; // type
