...
export const sampleContest: ContestData = {
  ...
  prizes: [
    {
      place: '1st Place',
      amount: '$1,000',
      description: 'Cash prize, featured winner spotlight, and priority licensing review.',
    },
    {
      place: '2nd Place',
      amount: '$600',
      description: 'Cash prize and official campaign feature across MOD channels.',
    },
    {
      place: '3rd Place',
      amount: '$400',
      description: 'Cash prize and honorable mention placement.',
    },
  ],
  ...
  judging: {
    criteria: [
      {
        title: 'Brand Fit',
        description: 'How well the concept reflects the source IP, campaign theme, and audience.',
      },
      {
        title: 'Originality',
        description: 'Fresh interpretation, authenticity, and clearly original creative work.',
      },
      {
        title: 'Commercial Appeal',
        description: 'Merch readiness, print viability, and product marketability.',
      },
      {
        title: 'Execution',
        description: 'Strong composition, quality, technical polish, and file readiness.',
      },
    ],
  ...
  legal: {
    ...
    rightsGranted:
      'Commercial merchandising, digital promotion, and marketing use as specified in final agreement.',
    territory: 'Global',
  ...
  faq: [
    {
      ...
      answer:
        'Yes. This campaign allows up to 3 entries per artist unless otherwise stated in the submission rules.',
    },
    {
      question: 'Can my art be licensed even if I do not place in the top 3?',
      answer:
        'Yes. The brand may choose additional entries for licensing or future consideration outside the official prize ranking.',
    },
    {
      question: 'Can I use AI tools?',
      answer:
        'Only if the campaign allows it and you disclose your process. Fully AI generated, non transformative submissions may be rejected.',
    },
    {
      question: 'Where will winning merchandise be sold?',
      answer:
        'Depending on approvals, products may launch on the MOD marketplace, the brand store, or both.',
    },
  ],
