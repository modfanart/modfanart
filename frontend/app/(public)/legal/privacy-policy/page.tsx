        ...
        <div className="mx-auto max-w-4xl">
          ...
          <Card className="mb-8">
            ...
            <CardContent className="space-y-4">
              <p>
                At MOD Platform, we respect your privacy and are committed to protecting your
                personal data. This Privacy Policy explains how we collect, use, and safeguard your
                information when you use our platform.
              </p>
              <p>
                By using the MOD Platform, you consent to the data practices described in this
                policy.
              </p>
            </CardContent>
          </Card>
          ...
          <Card className="mb-8">
            ...
            <CardContent className="space-y-4">
              ...
              <p>
                When you submit artwork, we use AI tools to analyze your submissions for compliance
                and authenticity. This analysis may include:
              </p>
              <ul className="list-disc pl-6 space-y-2">
