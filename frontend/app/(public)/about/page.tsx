      ...
      <section className="relative w-full h-[80vh] min-h-[500px] overflow-hidden">
        ...
        <div className="absolute inset-0 flex flex-col items-center justify-center text-center text-white px-4 z-20">
          ...
          <p className="mt-8 text-sm text-gray-300 max-w-2xl leading-relaxed">
            Fan art has always been part of culture. It's how people show connection, loyalty, and
            creativity around the things they love.
            <br />
            But for a long time, there was no clear place for that creativity to go. Artists were
            created in legal gray areas.
          </p>
          <p className="mt-4 text-sm text-gray-300 max-w-xl leading-relaxed">
            ...
            <br />
            And both sides were missing real opportunities because the system wasn't built for
            collaboration.
            <br />
          ...
          <div className="flex flex-col md:flex-row rounded-3xl overflow-hidden shadow-lg">
            ...
            <div className="flex-1 bg-[#111] text-white p-10">
              <p className="text-sm text-gray-300 leading-relaxed">
                ...
                <br />
                Fans were already creating incredible work inspired by shows, games, music, and
                brands.
              </p>
              ...
              <p className="mt-5 text-sm text-gray-300 leading-relaxed">
                ...
                <br />
                There was no simple, legal way for fan art to move from inspiration to official
                licensing.
                <br />
                So we built MOD to fill that gap, not as a marketplace, but as a platform designed
                around approval, compliance, and trust.
              </p>
            </div>
      ...
      <section className="bg-white py-20 px-6 ">
        <div className="max-w-3xl mx-auto text-center">
          ...
          <p className="mt-8 text-sm text-gray-500 leading-relaxed max-w-2xl mx-auto">
            Every step is structured and supported by intelligent automation designed to streamline
            review, protect brand standards, and maintain transparency.
          </p>
          <p className="mt-4 text-sm text-gray-500 leading-relaxed max-w-2xl mx-auto">
            Our system combines AI-assisted screening with brand-led approval, making collaboration
            possible at scale while preserving full human oversight.
          </p>
        </div>
      </section>
              ...
              <div className="mt-4 space-y-3">
                {[
                  ...
                  { icon: <FileCheck size={15} />, text: 'Transparent licensing processes' },
                  {
                    ...
                    text: 'Long-term collaboration over short-term wins',
                  },
                ].map(({ icon, text }, i) => (
          ...
          <div className="relative rounded-3xl overflow-hidden min-h-[360px]">
            ...
            <div className="relative z-10 flex flex-col items-center justify-center text-center text-white px-8 py-16">
              ...
              <p className="mt-4 text-sm text-gray-300 max-w-xl leading-relaxed">
                ...
                <br />
                Our goal is to make fan licensing a recognized industry standard, one campaign, one
                artist, and one brand partnership at a time.
              </p>
            </div>
          </div>
        </div>
