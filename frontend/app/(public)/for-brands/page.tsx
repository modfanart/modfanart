      ...
      <section className="relative w-full h-[80vh] min-h-[500px] overflow-hidden">
        ...
        <div className="absolute inset-0 flex flex-col items-center justify-center text-center text-white px-4 mt-16 z-20">
          <h1 className="text-5xl md:text-6xl font-black leading-tight tracking-tight">
            ACTIVATE YOUR <span className="bg-purple-600 text-white px-2 rounded-sm">FANDOM.</span>
            <br />
          ...
          <p className="mt-6 text-sm text-gray-300 max-w-2xl leading-relaxed">
            MOD Fan Official helps brands turn fan creativity into officially licensed merchandise
            through structured campaigns, clear guidelines, and brand-led approval. Fans already
            create art inspired by your IP.
            <br />
            MOD gives you a safe, controlled way to engage it, without losing ownership, control, or
            credibility.
          </p>
          <p className="mt-3 text-sm text-gray-300 max-w-2xl leading-relaxed">
            MOD is more than a marketplace. It is structured licensing infrastructure designed to
            help you activate fan creativity with intelligence and control. Nothing goes live
      ...
      <section className="bg-white py-24 px-6 text-center">
        <div className="max-w-3xl mx-auto">
          ...
          <p className="mt-5 text-sm text-gray-500">
            Fan art doesn't stop because a brand ignores it.
          </p>
          ...
          <p className="mt-8 text-sm text-gray-500 leading-relaxed">
            Most brands don't have the time or internal resources to review thousands of
            submissions.
            <br />
        ...
        <div className="max-w-5xl mx-auto">
          <div className="flex flex-col md:flex-row rounded-3xl overflow-hidden shadow-lg bg-[#F4F4F4]">
            ...
            <div className="flex-1 p-10">
              ...
              <p className="mt-4 text-sm text-gray-600 leading-relaxed">
                This <strong>keeps your IP protected</strong> while opening the door to real
      ...
      <section className="bg-white py-16 px-6">
        <div className="max-w-5xl mx-auto text-center">
          ...
          <div className="mt-8 flex flex-wrap justify-center gap-6">
            {['Fans feel recognized.', 'Artists earn royalties.', 'Brands stay in control.'].map(
              (t, i) => (
          ...
          {[
            {
              ...
              answer:
                "Every submission is screened against your brand guidelines using MOD's AI-powered review system. Nothing moves forward without your explicit approval, ensuring full IP control at every step.",
            },
            {
              question: 'What licensing options are available?',
              answer:
                'MOD supports flexible licensing structures. You define usage rights, royalty terms, and territory scope for each approved design before it goes to production.',
            },
            {
              question: 'How are royalties tracked and distributed?',
              answer:
                'Sales data is tracked transparently through the platform. Royalties are calculated automatically and distributed to artists on a defined schedule, with full visibility for your team.',
            },
            {
              question: 'Can MOD integrate with our existing systems?',
              answer:
                'MOD offers API access and integrations with common brand management and e-commerce platforms. Contact our team to discuss your specific technical requirements.',
            },
          ].map((faq, i) => (
