      ...
      <section className="relative w-full h-[80vh] min-h-[500px] overflow-hidden">
        ...
        <div className="absolute inset-0 flex flex-col items-center justify-center text-center text-white px-4 z-20">
          ...
          <h1 className="text-5xl md:text-6xl font-black leading-tight tracking-tight mt-2">
            GET IT OFFICIALLY{' '}
            <span className="bg-purple-600 text-white px-1 py-0 leading-none rounded-sm">
              LICENSED.
            </span>
          </h1>

          <p className="mt-6 text-sm text-gray-300 max-w-2xl leading-relaxed">
            Fan art has always been powerful. Turning it into something official has always been the
            hard part.
            <br />
            MOD Fan Official gives artists a real path to get fan art licensed, approved, and turned
            into official merchandise, without guessing what's allowed or risking takedowns.
          </p>
      ...
      <section className="bg-white py-24 px-6">
        <div className="max-w-3xl mx-auto">
          ...
          <p className="mt-5 text-sm text-gray-500 text-center">
            Most fan art lives in a gray area.
          </p>
          ...
          <p className="mt-8 text-sm text-gray-500 text-center">
            Even great work struggles to move forward when there's no clear approval process behind
            it.
          </p>
        </div>
      </section>
          ...
          <div className="flex flex-col md:flex-row rounded-3xl overflow-hidden shadow-lg bg-[#F4F4F4] border border-blue-200">
            ...
            <div className="flex-1 p-10">
              ...
              <p className="text-sm text-gray-600 leading-relaxed">
                MOD was built to give <strong>fan artists</strong> a legitimate way in. Instead of
                posting into the void, artists submit work through official campaigns.
              </p>
              <p className="mt-4 text-sm text-gray-600 leading-relaxed">
                Instead of hoping for permission, artists work within{' '}
                <strong>brand guidelines.</strong>
                <br />
                Instead of worrying about <strong>copyright</strong>, artists know exactly where
                they stand.
              </p>
              <p className="mt-4 text-sm text-gray-600 leading-relaxed">
        ...
        <div className="max-w-3xl mx-auto">
          ...
          <div className="mt-14 space-y-10">
            {[
              ...
              {
                icon: <img src={license1.src} alt="icon" className="w-5 h-5 object-contain" />,
          ...
          <div className="relative rounded-3xl overflow-hidden bg-black text-white text-center py-16 px-8">
            ...
            <div className="relative z-10">
              ...
              <p className="mt-5 text-sm text-gray-300 max-w-xl mx-auto">
                If you've been creating fan art and wondering how to take the next step, this is
                where it starts.
              </p>
          ...
          {[
            {
              ...
              answer:
                "You can submit fan art tied to active brand campaigns on MOD. Each campaign has its own creative brief and brand guidelines that outline what's acceptable. You must submit within those defined parameters.",
            },
            {
              question: 'How long does approval take?',
              answer:
                "Approval timelines vary by campaign and brand. Once submitted, your work enters a structured review queue. You'll be notified of the status through your artist dashboard.",
            },
            {
              question: 'Do I keep ownership of my art?',
              answer:
                'Artists retain creative credit for their work. When a design is licensed, a formal agreement outlines usage rights. You are always credited as the original creator of the licensed piece.',
            },
            {
              question: 'How do royalties work?',
              answer:
                'When your approved design is sold as licensed merchandise, you earn a royalty based on the terms set in your licensing agreement. Sales and payouts are tracked transparently through the platform.',
            },
            {
              question: 'Is there a cost to join?',
              answer:
                'Creating an artist profile and submitting to campaigns is free. MOD earns through the licensing and merchandise process, not by charging artists upfront.',
            },
          ].map((faq, i) => (
