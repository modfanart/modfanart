...
import { getSubmissionsByUserId, getSubmissionsByStatus, createSubmission } from "@/lib/db/models/submission"
...
export async function POST(request: NextRequest) {
  try {
    ...
    if (!title || !description || !category || !originalIp || !imageUrl || !licenseType || !userId) {
