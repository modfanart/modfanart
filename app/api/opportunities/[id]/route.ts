...
const mockOpportunities = [
  ...
  },
  {
    ...
    description: "Create your own interpretation of Marvel superheroes. Winners will be featured in a digital gallery.",
    brand: "Marvel",
...
export async function PUT(request: Request, { params }: { params: { id: string } }) {
  try {
    ...
    // In a real implementation, update the opportunity in the database
    console.log(`Updating opportunity ${params.id}:`, body)
...
export async function DELETE(request: Request, { params }: { params: { id: string } }) {
  try {
    // In a real implementation, delete the opportunity from the database
    console.log(`Deleting opportunity ${params.id}`)
