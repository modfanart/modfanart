    ...
    <LayoutWrapper>
      <div className="container py-12 md:py-24">
        <div className="mx-auto max-w-4xl text-center">
          ...
          <p className="mt-4 text-lg text-muted-foreground">Choose the perfect plan for your fan art licensing needs</p>
        </div>
              ...
              <div className="mx-auto grid max-w-5xl gap-8 md:grid-cols-3">
                ...
                <Card className="flex flex-col">
                  <CardHeader>
                    ...
                    <CardDescription className="mt-2">For content creators and small IP holders</CardDescription>
                  </CardHeader>
                  <CardContent className="flex-1">
                    <ul className="space-y-3">
                      <li className="flex items-start">
                ...
                <Card className="flex flex-col">
                  <CardHeader>
                    ...
                    <div className="mt-4 flex items-baseline text-5xl font-extrabold">
                      Custom<span className="ml-1 text-xl font-medium text-muted-foreground">/year</span>
                    </div>
                    <CardDescription className="mt-2">
        ...
        <div className="mx-auto mt-16 max-w-3xl">
          ...
          <div className="grid gap-6 md:grid-cols-3">
            <div className="flex flex-col items-center text-center">
              ...
              <p className="text-sm text-muted-foreground">Automated content moderation and IP compliance checking</p>
            </div>
            <div className="flex flex-col items-center text-center">
              <div className="mb-4 rounded-full bg-primary/10 p-3">
              ...
              <p className="text-sm text-muted-foreground">Secure licensing agreements and IP protection tools</p>
            </div>
            <div className="flex flex-col items-center text-center">
              <div className="mb-4 rounded-full bg-primary/10 p-3">
              ...
              <p className="text-sm text-muted-foreground">Automated royalty distribution and payment processing</p>
            </div>
          </div>
        </div>
          ...
          <div className="flex flex-col md:flex-row gap-8 items-center">
            <div className="md:w-2/3">
              ...
              <p className="text-muted-foreground mb-4">
                Our enterprise plans are tailored to your specific needs. Contact our sales team to discuss a custom
          ...
          <div className="space-y-4">
            <div className="rounded-lg border p-4">
              ...
              <p className="text-muted-foreground">
                Our revenue share model splits the earnings from licensed fan art between the artist, the IP holder, and
                our platform. The exact percentages vary by plan, with higher-tier plans offering more favorable rates
                to both artists and IP holders.
              </p>
            </div>
            <div className="rounded-lg border p-4">
              ...
              <p className="text-muted-foreground">
                ...
                next billing cycle. Upgrades give you immediate access to new features.
              </p>
            </div>
            <div className="rounded-lg border p-4">
              <h3 className="font-medium mb-2">Is there a limit to how many submissions I can make?</h3>
              <p className="text-muted-foreground">
                No, all plans include unlimited submissions. However, higher-tier plans offer priority review, meaning
                your submissions will be processed faster.
              </p>
            </div>
            <div className="rounded-lg border p-4">
              <h3 className="font-medium mb-2">How do payments work for licensed artwork?</h3>
              <p className="text-muted-foreground">
                When your artwork is licensed, we handle all payment processing and automatically distribute royalties
                based on your plan's revenue share model. Payments are made monthly for all sales that occurred in the
                previous month.
              </p>
            </div>
          </div>
