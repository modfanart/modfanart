...
import { PlusCircle, ArrowUpRight, BarChart3, CheckCircle2, ImageIcon, AlertTriangle } from "lucide-react"
        ...
        <Card className="col-span-12 md:col-span-4">
          ...
          <CardContent>
            <div className="space-y-8">
              <div>
                <h3 className="text-sm font-medium text-muted-foreground mb-3">AI Detection Scores</h3>
                    ...
                    <Card className="overflow-hidden hover:shadow-md transition-shadow">
                      ...
                      <CardContent className="p-4">
                        <div className="flex flex-col space-y-1">
                          ...
                          <div className="mt-1">
                            <span className="text-xs px-2 py-1 rounded-full bg-blue-100 text-blue-800">Licensed</span>
                          </div>
                        </div>
                      </CardContent>
                    </Card>
